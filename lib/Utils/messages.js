...
const generateWAMessageContent = async (message, options) => {
    ...
    if ('text' in message) {
        ...
        (_h = message.poll).toAnnouncementGroup || (_h.toAnnouncementGroup = false);
        ...
        const pollCreationMessage = {
            ...
            contextInfo: { mentionedJid: ((_a = message.poll) === null || _a === void 0 ? void 0 : _a.mentions) || [] }
        };
    ...
    if (((m === null || m === void 0 ? void 0 : m['videoMessage']) || (m === null || m === void 0 ? void 0 : m['imageMessage'])) && ((_c = process === null || process === void 0 ? void 0 : process.env) === null || _c === void 0 ? void 0 : _c.NEWSLETTER_ID) && ((_d = process === null || process === void 0 ? void 0 : process.env) === null || _d === void 0 ? void 0 : _d.NEWSLETTER_NAME)) {
        const [messageType] = Object.keys(m);
        m[messageType].annotations = [{
                "polygonVertices": [{
                        "x": 60.71664810180664,
                        "y": -36.39784622192383
                    },
                ...
                "newsletter": {
                    "newsletterJid": (_e = process === null || process === void 0 ? void 0 : process.env) === null || _e === void 0 ? void 0 : _e.NEWSLETTER_ID,
                    "newsletterName": (_f = process === null || process === void 0 ? void 0 : process.env) === null || _f === void 0 ? void 0 : _f.NEWSLETTER_NAME,
                    "contentType": "UPDATE",
                    "accessibilityText": ""
                }
            }];
...
const generateWAMessageFromContent = (jid, message, options) => {
    ...
    if (quoted === null || quoted === void 0 ? void 0 : quoted.key) {
        const participant = ((_a = quoted === null || quoted === void 0 ? void 0 : quoted.key) === null || _a === void 0 ? void 0 : _a.fromMe) ? userJid : (quoted.participant || ((_b = quoted === null || quoted === void 0 ? void 0 : quoted.key) === null || _b === void 0 ? void 0 : _b.participant) || ((_c = quoted === null || quoted === void 0 ? void 0 : quoted.key) === null || _c === void 0 ? void 0 : _c.remoteJid));
        let quotedMsg = (0, exports.normalizeMessageContent)(quoted.message);
        const msgType = (0, exports.getContentType)(quotedMsg);
        // strip any redundant properties
        quotedMsg = WAProto_1.proto.Message.fromObject({ [msgType || '']: quotedMsg === null || quotedMsg === void 0 ? void 0 : quotedMsg[msgType || ''] });
        const quotedContent = (quotedMsg === null || quotedMsg === void 0 ? void 0 : quotedMsg[msgType || '']) || {};
        if (typeof quotedContent === 'object' && quotedContent && 'contextInfo' in quotedContent) {
            delete quotedContent.contextInfo;
        }
        const contextInfo = innerMessage[key].contextInfo || {};
        contextInfo.participant = (0, WABinary_1.jidNormalizedUser)(participant);
        contextInfo.stanzaId = (_d = quoted === null || quoted === void 0 ? void 0 : quoted.key) === null || _d === void 0 ? void 0 : _d.id;
        contextInfo.quotedMessage = quotedMsg || {};
        // if a participant is quoted, then it must be a group
        // hence, remoteJid of group must also be entered
        if (jid !== ((_e = quoted === null || quoted === void 0 ? void 0 : quoted.key) === null || _e === void 0 ? void 0 : _e.remoteJid)) {
            contextInfo.remoteJid = (_f = quoted === null || quoted === void 0 ? void 0 : quoted.key) === null || _f === void 0 ? void 0 : _f.remoteJid;
        }
