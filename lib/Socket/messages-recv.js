            ...
            await Promise.all([
                processingMutex.mutex(async () => {
                    ...
                    if (msg.messageStubType === WAProto_1.proto.WebMessageInfo.StubType.CIPHERTEXT) {
                        ...
                        if (isAnyHistoryMsg) {
                            if (((_b = node === null || node === void 0 ? void 0 : node.attrs) === null || _b === void 0 ? void 0 : _b.addressing_mode) === "lid" && ((_c = node === null || node === void 0 ? void 0 : node.attrs) === null || _c === void 0 ? void 0 : _c.participant_pn)) {
                                msg.key.id = (0, WABinary_1.jidNormalizedUser)(node.attrs.participant_pn);
                            }
                            const jid = (0, WABinary_1.jidNormalizedUser)(msg.key.remoteJid);
                            await sendReceipt(jid, undefined, [msg.key.id], 'hist_sync');
                        }
                    }
                    if (((_d = node === null || node === void 0 ? void 0 : node.attrs) === null || _d === void 0 ? void 0 : _d.addressing_mode) === 'lid' && ((0, WABinary_1.jidNormalizedUser)((_e = node === null || node === void 0 ? void 0 : node.attrs) === null || _e === void 0 ? void 0 : _e.participant) === (0, WABinary_1.jidNormalizedUser)(authState.creds.me.lid))) {
                        msg.key.jid = (0, WABinary_1.jidNormalizedUser)(authState.creds.me.id);
                    }
                    if (((_f = node === null || node === void 0 ? void 0 : node.attrs) === null || _f === void 0 ? void 0 : _f.addressing_mode) === 'lid' && ((_g = node === null || node === void 0 ? void 0 : node.attrs) === null || _g === void 0 ? void 0 : _g.participant_pn)) {
                        msg.key.jid = (0, WABinary_1.jidNormalizedUser)((_h = node === null || node === void 0 ? void 0 : node.attrs) === null || _h === void 0 ? void 0 : _h.participant_pn);
                    }
