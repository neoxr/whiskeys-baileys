...
const extractGroupMetadata = (result) => {
    ...
    const groupId = ((_b = (_a = group === null || group === void 0 ? void 0 : group.attrs) === null || _a === void 0 ? void 0 : _a.id) === null || _b === void 0 ? void 0 : _b.includes('@')) ? group.attrs.id : (0, WABinary_1.jidEncode)((_c = group === null || group === void 0 ? void 0 : group.attrs) === null || _c === void 0 ? void 0 : _c.id, 'g.us');
    const eph = (_d = (0, WABinary_1.getBinaryNodeChild)(group, 'ephemeral')) === null || _d === void 0 ? void 0 : _d.attrs.expiration;
    ...
    const metadata = {
        ...
        desc,
        descId,
        linkedParent: ((_e = (0, WABinary_1.getBinaryNodeChild)(group, 'linked_parent')) === null || _e === void 0 ? void 0 : _e.attrs.jid) || undefined,
        ...
        participants: (0, WABinary_1.getBinaryNodeChildren)(group, 'participant').map(({ attrs }) => {
            return {
                ...
                ...((attrs === null || attrs === void 0 ? void 0 : attrs.phone_number) ? { jid: attrs.phone_number } : {})
            };
        }),
